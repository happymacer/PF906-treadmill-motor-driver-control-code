...
# 2 "<built-in>" 2
# 1 "PF906_base_code_v4b.c" 2
# 114 "PF906_base_code_v4b.c"
# 1 "./PF906header.h" 1
# 42 "./PF906header.h"
...
# 1 "C:/Users/paul nonadmin/.mchp_packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__size_t.h" 1 3
...
# 1 "C:/Users/paul nonadmin/.mchp_packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__null.h" 1 3
...
# 58 "./PF906header.h" 2
# 114 "PF906_base_code_v4b.c" 2
# 183 "PF906_base_code_v4b.c"
const int TestVoltage = 0x214;
const int minimumVoltage = 0x10E;



int HV = 0, IV = 0, MV = 0;

uint8_t button_history_speedUP = 0b11111111;
uint8_t button_history_speedDN = 0b11111111;
uint8_t button_history_UserPowerOn_input = 0b00000000;
...
volatile int actualSpeedPulses = 0;
...
void main(void) {
    ...
    PORTBbits.RB7 = 0x00;
    PORTAbits.RA5 = 0x00;
# 270 "PF906_base_code_v4b.c"
    HV = CheckHV();
    while (HV <= TestVoltage) {
...
# 314 "PF906_base_code_v4b.c"
    ...
    while (PORTCbits.RC7 && PORTBbits.RB7) {
# 384 "PF906_base_code_v4b.c"
        PORTAbits.RA1 = 0x01;


        button_history_speedUP = button_history_speedUP << 1;
        button_history_speedUP |= PORTBbits.RB6;
        button_history_speedDN = button_history_speedDN << 1;
        button_history_speedDN |= PORTBbits.RB5;

        if (button_history_speedUP == 0b10000000) {
            if (desiredSpeedCtr < 11) ++desiredSpeedCtr;


        };
        if (button_history_speedDN == 0b10000000) {
...
void FlashLED1 (uint8_t times, uint8_t period) {
    ...
    do {
        PORTCbits.RC4 = 0x01;
        do {_delay((unsigned long)((50)*(8000000/4000.0)));
           } while (--p);
        p = period;
        PORTCbits.RC4 = 0x00;
        do {_delay((unsigned long)((50)*(8000000/4000.0)));
...
# 558 "PF906_base_code_v4b.c"
    ...
    startPWM();
# 598 "PF906_base_code_v4b.c"
    T1CON = 0b00100000;
    TMR1L = 0xAF;
    TMR1H = 0x3C;
    PIE1bits.CCP1IE = 0x00;
...
int CheckMV (){
    ...
    ADCON0bits.GO_nDONE = 0x01;
    while (ADCON0bits.GO_nDONE) {};
    return (ADRESL | (ADRESH<<8));
};
# 647 "PF906_base_code_v4b.c"
int CheckIV (){
...
void startPWM(){
# 776 "PF906_base_code_v4b.c"
    TRISCbits.TRISC5 = 0x01;
# 790 "PF906_base_code_v4b.c"
    PR2 = 0x65;
# 804 "PF906_base_code_v4b.c"
    CCP1CON = 0b00001110;
...
void __attribute__((picinterrupt(("")))) Isr(void) {
    ...
    if (PIE1bits.TMR1IE && PIR1bits.TMR1IF) {
        ...
        CM1CON0bits.C1ON = 0x00;
        T1CONbits.TMR1ON = 0x00;


    };
# 889 "PF906_base_code_v4b.c"
};
